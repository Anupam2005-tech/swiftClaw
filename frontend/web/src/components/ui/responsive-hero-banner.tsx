...
const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
    ...
    secondaryButtonHref = "https://github.com/Anupam2005-tech/swiftClaw",
    ...
    return (
        ...
        <section className="w-full isolate min-h-screen overflow-hidden relative bg-black font-sans selection:bg-white/20">
                        ...
                        <Tooltip delayDuration={0}>
                            <TooltipTrigger asChild>
                                <button
                                    ...
                                    className="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/15 backdrop-blur transition-colors hover:bg-white/15"
                                    aria-expanded={mobileMenuOpen}
                                    aria-label="Toggle menu"
                                >
                                    {mobileMenuOpen ? (
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white/90">
            ...
            {/* Mobile Menu Panel */}
            {mobileMenuOpen && (
              <div className="md:hidden z-20 relative px-6 pt-4">
                <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur-xl p-4 flex flex-col gap-2">
                  <Link
                    href="/docs"
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    onClick={() => setMobileMenuOpen(false)}
                    className="mt-1 inline-flex items-center justify-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-medium text-neutral-900 hover:bg-white/90 transition-colors"
                  >
                    {ctaButtonText}
                    <Star className="h-4 w-4 fill-neutral-900" />
                  </a>
