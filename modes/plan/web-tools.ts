  ...
  return {
    web_search: tool({
      ...
      execute: async ({ query, limit }) => {
        uiTracker?.update(`Calling web_search...`);
        try {
          ...
          uiTracker?.update(`Finished web_search`);
        }
      },
    }),
    ...
    web_crawl: tool({
      ...
      execute: async ({ url }) => {
        uiTracker?.update(`Calling web_crawl...`);
        try {
          ...
          uiTracker?.update(`Finished web_crawl`);
        }
      },
    }),
    ...
    fetch_url: tool({
      ...
      inputSchema: z.object({ url: z.string().url() }),
      execute: async ({ url }) => {
        uiTracker?.update(`Calling fetch_url...`);
        try {
          ...
          uiTracker?.update(`Finished fetch_url`);
        }
      },
    }),
  };
